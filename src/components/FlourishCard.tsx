...
const FlourishCard = () => {
  ...
  return (
    <section id="flourish" className="py-20 bg-gradient-to-br from-pale-pink via-snow-white to-pale-blue/30">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-steel-blue to-mint-green rounded-2xl p-8 text-snow-white shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-300">
                <div className="flex items-center justify-between mb-6">
                  <h4 className="text-2xl font-bold">FLOURISH</h4>
                  <CreditCard className="w-8 h-8" />
                </div>
                <div className="mb-6">
                  <p className="text-snow-white/80 text-sm mb-2">Member Name</p>
                  <p className="text-xl font-semibold">Care Professional</p>
                </div>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <p className="text-snow-white/80">Member Since</p>
                    <p className="font-semibold">2024</p>
                  </div>
                  <div>
                    <p className="text-snow-white/80">Status</p>
                    <p className="font-semibold">Active</p>
                  </div>
                </div>
                <div className="mt-6 pt-4 border-t border-snow-white/20">
                  <p className="text-xs text-snow-white/80">
          ...
          {/* Call to Action */}
          <Card className="bg-gradient-to-r from-rose-pink to-mint-green text-snow-white border-0 shadow-xl">
            <CardContent className="p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-snow-white text-rose-pink hover:bg-snow-white/90 font-semibold text-lg px-8">
                  Start Application
                </Button>
                <Button size="lg" variant="outline" className="border-2 border-snow-white text-snow-white hover:bg-snow-white hover:text-rose-pink font-semibold text-lg px-8">
                  Contact Support
                </Button>
              </div>
            </CardContent>
